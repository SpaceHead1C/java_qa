...
import ru.nd.addressbook.appmanager.ApplicationManager;
import ru.nd.addressbook.model.GroupData;
...
public class GroupStepDefenitions {
    ...
    public void verifyGroupCreated() {
        ...
        assertThat(newGroups, equalTo(
                groups.withAdded(newGroup.withId(newGroups.stream().mapToInt(GroupData::getId).max().getAsInt()))));
    }
}
